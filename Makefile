...
extract_translations: ## extract strings to be translated, outputting .po files
	...
	mkdir -p gradefetcher/translations/en/LC_MESSAGES/
	rm -f gradefetcher/translations/en/LC_MESSAGES/*
	django-admin makemessages -l en -v1 -d django
	mv gradefetcher/translations/en/LC_MESSAGES/django.po gradefetcher/translations/en/LC_MESSAGES/text.po
